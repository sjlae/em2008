	...
	<table  class="table-striped table-responsive table-hover result-point">
		...
		?>
					<tr>
						...
						<td valign="top" style="padding-left: 5px"><?php echo $spiel['team2']; ?></td>
						<td align="center" valign="top">
							<input type="text" style="width: 20px" value="<?php echo $spiel['result1']; ?>" <?php echo $spiel['disabled']; ?> name="result1<?php echo $spiel['id']; ?>" maxLength="2" /></td>
						<td valign="top">:</td>
						<td align="center" valign="top"><input type="text" style="width: 20px" value="<?php echo $spiel['result2']; ?>"	<?php echo $spiel['disabled']; ?> name="result2<?php echo $spiel['id']; ?>" maxLength="2" />
						</td>
						<td align="center" valign="top">
							<?php if($spiel['highrisk'] == 1){ ?>
								<input type="checkbox" name="games_highrisk<?php echo $spiel['id']; ?>" value="<?php echo $spiel['id']; ?>" <?php echo $spiel['disabled']; ?> checked/>
