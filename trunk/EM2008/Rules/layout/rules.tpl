<h2>Spielregeln</h2>
		...
		unter dem Men&uuml;punkt 'Rangliste' ersichtlich. Die Viertelfinal-Teilnehmer werden erst nach Beendigung s&auml;mtlicher Vorrundenspiele 
		aktualisiert und in der Rangliste ber&uuml;cksichtigt.</p>
		<h3>Auszahlungsstruktur</h3>
		<ul>
			<li><b>1. Platz</b> &nbsp;<img alt="" src="pfeil_rechts.png" style="width: 35px; height: 15px"/>&nbsp; der Sieger des EM-Tippspieles erh&auml;lt 50% des gesamten Pots.</li>
			<li><b>2. Platz</b> &nbsp;<img alt="" src="pfeil_rechts.png" style="width: 35px; height: 15px"/>&nbsp;der Zweitplatzierte des EM-Tippspiels darf sich &uuml;ber 30% des gesamten Pots erfreuen.</li>
			<li><b>3. Platz</b> &nbsp;<img alt="" src="pfeil_rechts.png" style="width: 35px; height: 15px"/>&nbsp; der Drittplatzierte des EM-Tippspiels muss sich mit 20% des gesamten Pots abfinden.</li>
		</ul>
		<p>
		Bei Punktegleichstand am Schluss innerhalb der ersten drei R&auml;ngen gelten nachstehende Kriterien f&uuml;r die Ermittlung der R&auml;nge. 
		Besser rangiert ist derjenige, welcher</p>
		<ol>
			<li>der richtige Europameister hat</li>
			...
			<li>mehr komplett richtige Vorrundentipps hat</li>
		...
		speziell markiert auf der Ranglisten-Seite. Wer bis am <b>15. Juni 2008</b> noch nicht bezahlt hat, wird vom EM-Tippspiel ausgeschlossen.</p>
